...
import argparse
from database.db_connector_deprecated import DBConnector, insert_user, create_channel_table, get_user_ranking, user_in_table

signing_secret = os.environ['TEST_SIGNING_SECRET']
bot_id = os.environ['TEST_BOT_ID']
